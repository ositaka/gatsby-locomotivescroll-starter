...
const Pagination = ({ currentPage, numberOfPages }) => {
    ...
    return (
        <div className="pagination">
            {isFirst ? (
                <button disabled><span className="prev">Prev</span></button>
            ) : (
                    <Link to={previousPage}><span className="prev">Prev</span></Link>
                )}
            ...
            {isLast ? (
                <button disabled><span className="next">Next</span></button>
            ) : (
                    <Link to={nextPage}><span className="next">Next</span></Link>
                )}
        </div>
    )
}
